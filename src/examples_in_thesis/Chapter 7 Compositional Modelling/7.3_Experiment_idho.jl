...
begin
    ...
    plot!(time_step, R_d__p__f, lw=2, label="Ground Truth")
...
begin
    using Plots
    plot(xlabel="Time Step", ylabel="sₑ.f", xlims=(0,100), ylims=(-0.035,0.035))
    plot!(time_step, R_d__s_e__f, lw=2, label="Ground Truth")
    plot!(time_step, f_θ__s_e__f, lw=2, label="Structured ODE NN")
