...
plt = plot(x_axis_ode_data, y_axis_ode_data, z1_axis_ode_data, label="Ground truth 1")
plt = plot!(x_axis_ode_data, y_axis_ode_data, z2_axis_ode_data, label="Ground truth 2")
...
plt = plot!(x_axis_est_data, y_axis_est_data, z1_axis_est_data, label="Estimation 1")
plt = plot!(x_axis_est_data, y_axis_est_data, z2_axis_est_data, label="Estimation 2")
