...
begin
    ...
    plot(xlabel="Time Step", ylabel="L2 Error", xlims=(0,100), ylims=(0,0.0001))
...
begin
    using Plots
    plot(xlabel="Time Step", ylabel="Dissipated Power of the damping", xlims=(0,100), ylims=(-0.2,0.4))
    plot!(time_step, target_dissipated_power_d, lw=3, label="Ground Truth", linestyle=:solid)
    plot!(time_step, estimate_dissipated_power_d, lw=3, label="Structured ODE NN", linestyle=:dash)
    #Plots.pdf(joinpath(@__DIR__, "figures", "dissipated_power_damping_idho.pdf"))
end
...
begin
    ...
    plot!(ode_data[1,:], ode_data[2,:], lw=3, label="Ground Truth", linestyle=:solid)
    plot!(predict_data_Structured_ODE_NN[1,:], predict_data_Structured_ODE_NN[2,:], lw=3, label="Structured ODE NN", linestyle=:dash)
    #Plots.pdf(joinpath(@__DIR__, "figures", "phase_portrait_compositional_idho_reuse.pdf"))
end
...
begin
    using Plots
    l2_error_Structured_ODE_NN = vec(sum((ode_data .- predict_data_Structured_ODE_NN).^2, dims=1))
    plot(xlabel="Time Step", ylabel="L2 Error", xlims=(0,100), ylims=(0,0.0002))
    plot!(time_step, l2_error_Structured_ODE_NN, lw=3, label="Structured ODE NN")
    #Plots.pdf(joinpath(@__DIR__, "figures", "prediction_error_compositional_idho_reuse.pdf"))
end
...
begin
    ...
    plot!(time_step, round.(Hamiltonian_Ground_Truth, digits=10), lw=3, label="Ground Truth", linestyle=:solid)
    plot!(time_step, round.(Hamiltonian_Structured_ODE_NN, digits=10), lw=3, label="Structured ODE NN", linestyle=:dash)
    #Plots.pdf(joinpath(@__DIR__, "figures", "Hamiltonian_evolution_compositional_idho_reuse.pdf"))
end
...
begin
    ...
    plot!(time_step, R_d__p__f, lw=3, label="Ground Truth", linestyle=:solid)
    plot!(time_step, f_θ__p__f, lw=3, label="Structured ODE NN", linestyle=:dash)
    #Plots.pdf(joinpath(@__DIR__, "figures", "p.f_compositional_idho_reuse.pdf"))
end
...
begin
    ...
    plot!(time_step, R_d__s_e__f, lw=3, label="Ground Truth", linestyle=:solid)
    plot!(time_step, f_θ__s_e__f, lw=3, label="Structured ODE NN", linestyle=:dash)
    #Plots.pdf(joinpath(@__DIR__, "figures", "se.f_compositional_idho_reuse.pdf"))
end
...
begin
    ...
    plot!(time_step, target_dissipated_power_d, lw=3, label="Ground Truth", linestyle=:solid)
    plot!(time_step, estimate_dissipated_power_d, lw=3, label="Structured ODE NN", linestyle=:dash)
    #Plots.pdf(joinpath(@__DIR__, "figures", "dissipated_power_damping_idho_reuse.pdf"))
end